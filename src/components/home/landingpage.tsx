...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center bg-gray-50 overflow-hidden">
      ...
      {/* Glowing Text Effect */}
      <h1 className="relative text-[10vw] font-extrabold uppercase text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-blue-500 tracking-tight drop-shadow-lg">
        Project101
      </h1>
